...
public enum EncodeHintType {
   ...
   * {@link com.bitvault.qr.qrcode.decoder.ErrorCorrectionLevel ErrorCorrectionLevel}.
  ...
  /**
   * Specifies the matrix shape for Data Matrix (type {@link com.bitvault.qr.datamatrix.encoder.SymbolShapeHint})
   */
  DATA_MATRIX_SHAPE,
   ...
   * {@link com.bitvault.qr.datamatrix.DataMatrixWriter#encode(String, BarcodeFormat, int, int)}
   */
  @Deprecated
  MIN_SIZE,
   ...
   * {@link com.bitvault.qr.pdf417.encoder.Compaction Compaction} or {@link String} value of one of its
   * enum values).
   */
  PDF417_COMPACTION,
   ...
   * {@link com.bitvault.qr.pdf417.encoder.Dimensions Dimensions}).
   */
  PDF417_DIMENSIONS,
